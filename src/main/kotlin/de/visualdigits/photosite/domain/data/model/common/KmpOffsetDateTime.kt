...
import de.visualdigits.photosite.domain.data.serializer.KmpOffsetDateTimeHeuristicDeserializer
...
fun KmpOffsetDateTime.formatLocalized(pattern: String, locale: Locale = Locale.getDefault()): String {
    ...
    val javaOffsetDateTime = OffsetDateTime.ofInstant(javaInstant, javaOffset)
